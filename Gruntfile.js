module.exports = function(grunt) {
    ...
    var testHost = grunt.option('host');
            ...
            dev: {
                options: {
                    ...
                    args: {
                        ...
                        baseUrl: testHost||process.env.HOST||'https://www.test1-cms.gb.travelsupermarket.com/?source=TIV',
                        cucumberOpts: {
            ...
            all: {
                options: {
                    ...
                    args: {
                        ...
                        baseUrl: testHost||process.env.HOST||'https://www.test1-cms.gb.travelsupermarket.com/?source=TIV',
                        cucumberOpts: {
                            tags: ['~@ignore','@desktop','@mobile','@tabletL','@tabletP']
                        }
                    }
                }
            }
    ...
    grunt.registerTask('e2e', 'Run e2e tests', function(target) {
        ...
        if(!process.env.HOST){
            process.env.HOST='https://www.test1-cms.gb.travelsupermarket.com/?source=TIV';
        }
